...
// ----------------------------------------
// a option section for options Business  -
// ----------------------------------------
$options[]      = array(
  ...
  'fields'      => array(
      ...
      'id'      => 'heading_1',
      'type'    => 'text',
      'title'   => 'Heading One 1st Part',
    ),
      array(
      'id'      => 'heading_2',
      'type'    => 'text',
      'title'   => 'Heading One 2nd Part',
    ),
      array(
      'id'      => 'heading_3',
      'type'    => 'text',
      ...
      array(
          'id'              => 'business_group_section',
          'type'            => 'group',
          'title'           => 'Group Field',
          'button_title'    => 'Add New Business section',
          'accordion_title' => 'Add New Field',
          'fields'          => array(
            array(
              'id'    => 'business_icon',
              'type'  => 'icon',
              'title' => 'Give Business Icon',
            ),
            array(
              'id'    => 'business_head',
              'type'  => 'text',
              'title' => 'Give Business Heading',
            ),
            array(
              'id'    => 'business_des',
              'type'  => 'textarea',
              'title' => 'Give Business Description',
            ),
          ),
        ),
      array(
            'type'    => 'heading',
            'content' => 'Header Business Image',
          ),
      ...
      'id'      => 'b_v_image',
      'type'    => 'image',
      'title'   => 'Upload Business Vector Image',
    ),
      array(
              'id'    => 'vector_text_1',
              'type'  => 'text',
              'title' => 'Give Business Vector text 1',
            ),
      array(
              'id'    => 'vector_text_2',
              'type'  => 'text',
              'title' => 'Give Business Vector text 2',
            ),
...
// --------------------------------------------
// a option section for OUTSTANDING SERVICE   -
// --------------------------------------------
$options[]      = array(
  'name'        => 'outstand_service',
  ...
  'fields'      => array(
      array(
            'id'    => 'service_title',
            'type'  => 'text',
            'title' => 'Give Service Title',
          ),
      array(
            'id'    => 'service_des',
            'type'  => 'textarea',
            'title' => 'Give Service Description',
          ),
      array(
            'type'    => 'heading',
            'content' => 'Service group Section',
          ),
      array(
          'id'              => 'service_group',
          'type'            => 'group',
          'title'           => 'Give Service Type Details',
        ...
        'fields'          => array(
          array(
            'id'    => 's_icon',
            'type'  => 'icon',
            'title' => 'Give service type Icon',
          ),
          array(
            'id'    => 's_type_title',
            'type'  => 'text',
            'title' => 'Give Service Type Title',
          ),
          array(
            'id'    => 's_type_title_link',
            'type'  => 'text',
            'title' => 'Give Service Type Title Link',
          ),
          array(
                'id'      => 's_type_des',
                'type'    => 'textarea',
                'title'   => 'Give Your Service Type Description',
           ), 
        ),
      ),
...
// ----------------------------------------
// a option section for options Team      -
// ----------------------------------------
$options[]      = array(
  'name'        => 'team',
  'title'       => 'Team Section',
  ...
  'fields'      => array(
       array(
            'id'    => 'team_title',
            'type'  => 'text',
            'title' => 'Give Team Title',
          ),
      array(
            'id'    => 'team_des',
            'type'  => 'textarea',
            'title' => 'Give Team Description',
          ),

      array(
          'id'              => 'team_group',
          'type'            => 'group',
          'title'           => 'Give team Type Details',
          'button_title'    => 'Add New',
          'accordion_title' => 'Add New Field',
        'fields'          => array(
          array(
            'id'    => 'team_img',
            'type'  => 'image',
            'title' => 'Give team Member Image',
          ),
          array(
            'id'    => 'team_m_name',
            'type'  => 'text',
            'title' => 'Give Team Member Name',
          ),
          array(
            'id'    => 'team_m_desi',
            'type'  => 'text',
            'title' => 'Give Team Member Designation',
          ),
          array(
                'id'      => 'team_fb_icon',
                'type'    => 'icon',
                'title'   => 'Give Member FB Icon',
           ), 
          array(
                'id'      => 'team_fb_link',
                'type'    => 'text',
                'title'   => 'Give Member FB link',
           ), 
          array(
                'id'      => 'team_tweet_icon',
                'type'    => 'icon',
                'title'   => 'Give Member tweet Icon',
           ),
          array(
                'id'      => 'team_tweet_link',
                'type'    => 'text',
                'title'   => 'Give Member Tweet link',
           ),
           array(
                'id'      => 'team_gplus_icon',
                'type'    => 'icon',
                'title'   => 'Give Member Gplus Icon',
           ),  
           array(
                'id'      => 'team_gplus_link',
                'type'    => 'text',
                'title'   => 'Give Member Gplus link',
           ),
           array(
                'id'      => 'team_member_des',
                'type'    => 'textarea',
                'title'   => 'Give Member Description',
           ),
        ),
      ),
      array(
...
// ----------------------------------------
//option section for options Testimonial  -
// ----------------------------------------
$options[]      = array(
  'name'        => 'testimonial',
  'title'       => 'Testimonial',
  ...
  'fields'      => array(
      array(
          ...
          'type'            => 'group',
          'title'           => 'Give Testimonial Type Details',
          'button_title'    => 'Add New',
          'accordion_title' => 'Add New Field',
        'fields'          => array(
          array(
            'id'    => 'test_img',
            'type'  => 'image',
            'title' => 'Give Testimonial Image',
          ),
          array(
            'id'    => 'test_name',
            'type'  => 'text',
            'title' => 'Give Testimonial Name',
          ),
          array(
            'id'    => 'test_desig',
            'type'  => 'text',
            'title' => 'Give Testimonial Designation',
          ),
          array(
                'id'      => 'test_descrip',
                'type'    => 'textarea',
                'title'   => 'Give Testimonial Description',
           ), 
        ),
      ),
    ),
...
// ----------------------------------------
// a option section for Home Blog         -
// ----------------------------------------
$options[]      = array(
  'name'        => 'hone_blog',
  'title'       => 'Home Blog',
  ...
  'fields'      => array(
       array(
            'id'    => 'blog_head',
            'type'  => 'text',
            'title' => 'Give Blog Heading',
          ),
       array(
            'id'    => 'blog_des',
            'type'  => 'textarea',
            'title' => 'Give Blog Description',
          ),
    ),
);

// ---------------------------------------------------------------------------------------------------
// a option About us Page About Us--------------------------------------------------------------------
// ---------------------------------------------------------------------------------------------------
$options[]      = array(
  'name'        => 'about_page',
  'title'       => 'About Us Page',
  ...
  'fields'      => array(
       ...
       array(
            'id'    => 'about_title',
            'type'  => 'text',
            'title' => 'Give About Us title',
          ),
       array(
            'id'    => 'about_des1',
            'type'  => 'textarea',
            'title' => 'Give About us Description1',
          ),
       array(
            'id'    => 'about_des2',
            'type'  => 'textarea',
            'title' => 'Give About us Description2',
          ),
       array(
            'id'    => 'about_des3',
            'type'  => 'textarea',
            'title' => 'Give About us Description3',
          ),
       array(
            'id'    => 'about_us_img',
            'type'  => 'image',
            'title' => 'Give About us Image',
          ),

        array(
          'id'              => 'aboutus_group',
          'type'            => 'group',
          'title'           => 'Give About us Type Details',
          'button_title'    => 'Add New',
          'accordion_title' => 'Add New Field',
        'fields'          => array(
          array(
            'id'    => 'about_us_icon',
            'type'  => 'icon',
            'title' => 'Give About Us Icon',
          ),
          array(
            'id'    => 'about_us_text',
            'type'  => 'text',
            'title' => 'Give About Us Text',
          ),
...
// ----------------------------------------
// a option section for About us Story    -
// ----------------------------------------

$options[]      = array(
  'name'        => 'about_story_page',
  'title'       => 'About Us Page Story',
  'icon'        => 'fa fa-star',
  ...
  'fields'      => array(
       ...
       array(
            ...
            'type'  => 'text',
            'title' => 'Give About Us Story title',
          ),
       array(
            'id'    => 'about_story_des',
            'type'  => 'textarea',
            'title' => 'Give About us Story Description',
          ),
       array(
          'id'              => 'aboutus_progress_group',
          'type'            => 'group',
          'title'           => 'Give Progress Bar Type Details',
          'button_title'    => 'Add New',
          'accordion_title' => 'Add New Field',
        'fields'          => array(
          array(
            'id'    => 'progress_title',
            'type'  => 'text',
            'title' => 'Give Name of Progress Bar Type',
          ),
          array(
            'id'    => 'progress_percent_number',
            'type'  => 'number',
            'title' => 'Give Progress Number',
          ),
...
$options[]      = array(
  ...
  'fields'      => array(
        ...
        array(
            'id'    => 'happy_client_title',
            'type'  => 'text',
            'title' => 'Give Happy Client title',
          ),
       array(
            'id'    => 'happy_client_head_des',
            'type'  => 'textarea',
            'title' => 'Give Happy Client Description',
          ),
       array(
          'id'              => 'happy_client_group',
          'type'            => 'group',
          'title'           => 'Give happy client Type Details',
          'button_title'    => 'Add New',
          'accordion_title' => 'Add New Field',
        'fields'          => array(
          array(
          ...
          array(
            'id'    => 'happy_client_name',
            'type'  => 'text',
            'title' => 'Give Happy Client Name',
          ),
...
$options[]      = array(
  ...
  'fields'      => array(
        array(
          'id'              => 'sponsor_logo_group',
          'type'            => 'group',
          'title'           => 'Give Sponsor Logo',
          'button_title'    => 'Add New',
          'accordion_title' => 'Add New Field',
        'fields'          => array(
          array(
...
// ----------------------------------------------------------------------------------------------------
// a option section for Contact Us Page   -------------------------------------------------------------
// ----------------------------------------------------------------------------------------------------
$options[]      = array(
  'name'        => 'contactus',
  ...
  'fields'      => array(
       ...
       array(
        ...
        array(
          'id'              => 'contact_media_group',
          'type'            => 'group',
          'title'           => 'Give Contact Media Details',
          'button_title'    => 'Add New',
          'accordion_title' => 'Add New Field',
        'fields'          => array(
          array(
            'id'    => 'contact_link',
            'type'  => 'text',
            'title' => 'Give Contact Link',
          ),
          array(
            'id'    => 'contact_icon',
            'type'  => 'icon',
            'title' => 'Give Contact Icon',
          ),
        ),
    ),
...
$options[]      = array(
  ...
  'fields'      => array(
        ...
        array(
            'id'    => 'contact_us_title',
            'type'  => 'text',
            'title' => 'Give Contact Us Title',
          ),
        array(
            'id'    => 'c_description',
            'type'  => 'textarea',
            'title' => 'Give Contact Description',
          ),
        array(
            'id'    => 'c_address_icon',
            'type'  => 'icon',
            'title' => 'Give Contact Address Icon',
          ),
        array(
            'id'    => 'c_address',
            'type'  => 'textarea',
            'title' => 'Give Contact Address',
          ),
        array(
            'id'    => 'c_phone_icon',
            'type'  => 'icon',
            'title' => 'Give Contact Phone Icon',
          ),
        array(
            'id'    => 'c_phone_num1',
            'type'  => 'text',
            'title' => 'Give Contact Number 1',
          ),
        array(
            'id'    => 'c_phone_num2',
            'type'  => 'text',
            'title' => 'Give Contact Number 2',
          ),
        array(
            'id'    => 'c_email_icon',
            'type'  => 'icon',
            'title' => 'Give Contact Email Icon',
          ),
        array(
            'id'    => 'c_email_id',
            'type'  => 'text',
            'title' => 'Give Contact Email Id',
          ),
